...
; !function (win, undefined) {
    ...
    var config = {
        ...
        json: function (url, data, callback, error) {
            ...
            return this.json_ws(url, data, callback, error);
        },
        //由于webservice的特殊性，专门写一个
        json_ws: function (url, data, callback, error) {
            return $.ajax({
                url: url,
                type: 'POST',
                ...
                success: function (result) {
                    //在callback之前处理一下数据，因为，webservice会返回  {"d":"{......}"}
